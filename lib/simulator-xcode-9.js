      ...
      if (opts.isHeadless) {
        ...
        if (['Shutdown', 'Booted'].indexOf(serverState) === -1) {
          if (serverState !== 'Shutting Down') {
            // TODO: tvOS is has 'undefined' state and trying to shutdown and cannot shutdown
            // [iOSSim] Simulator A5D83865-87F5-4E4E-A090-B4AA09B66D10 is in 'undefined' state. Trying to shutdown...
//             [debug] [MJSONWP] Encountered internal error running command: Error: Simulator is not in 'Shutdown' state after 15000ms
            // [debug] [MJSONWP]     at waitForShutdown (/Users/simongranger/git/appium-ios-simulator/lib/simulator-xcode-9.js:97:15)
            // [HTTP] <-- POST /wd/hub/session 500 26630 ms - 187
            // [HTTP] 
            ...
            // [simctl] Unable to lookup in current state: Shutdown
            // [simctl]     at Object.wrappedLogger.errorAndThrow (/Users/simongranger/git/appium-youiengine-driver/node_modules/appium-support/lib/logging.js:78:13)
            // [simctl]     at simCommand (/Users/simongranger/git/appium-youiengine-driver/node_modules/node-simctl/lib/simctl.js:48:11)
            // (node:66166) UnhandledPromiseRejectionWarning: Error: simctl error running 'terminate': An error was encountered processing the command (domain=com.apple.CoreSimulator.SimError, code=164):
            // Unable to lookup in current state: Shutdown
            //     at Object.wrappedLogger.errorAndThrow (/Users/simongranger/git/appium-youiengine-driver/node_modules/appium-support/lib/logging.js:78:13)
            //     at simCommand (/Users/simongranger/git/appium-youiengine-driver/node_modules/node-simctl/lib/simctl.js:48:11)
            // (node:66166) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). (rejection id: 1)
            // (node:66166) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
  ...
  async updatePreferences (devicePrefs = {}, commonPrefs = {}) {
    ...
    if (!_.isEmpty(commonPrefs)) {
      //TODO: this needs to be on per platform basis
      // [debug] [iOSSim] Setting common Simulator preferences to {"RotateWindowWhenSignaledByGuest":true}
